                ...
                <table class="table table-bordered table-hover table-sm mb-0 req-table">
                    <thead class="table-dark">
                        <tr>
                            ...
                            <th>Crop Name</th>
                            <th>Description</th>
                            <th class="text-center">pH Range</th>
                            <th class="text-center">N Range<br><small class="fw-normal opacity-75">(ppm)</small></th>
                            <th class="text-center">P Range<br><small class="fw-normal opacity-75">(ppm)</small></th>
                            <th class="text-center">K Range<br><small class="fw-normal opacity-75">(ppm)</small></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-muted small">{{ $crop->description ?? '—' }}</td>
                            ...
                            <td class="text-center">
                                <span class="range-badge n-badge">
                                    {{ number_format($crop->min_nitrogen, 0) }} – {{ number_format($crop->max_nitrogen, 0) }}
                                </span>
                            </td>
                            <td class="text-center">
